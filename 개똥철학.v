...
(*  UNIVERSAL DIMENSION                              *)
(*                                                   *)
(*  A universal dimension (Top/Unknown) CANNOT       *)
(*  exist in this framework.                         *)
(*                                                   *)
(*  If it did, every entity would project to it,     *)
(*  all projections would collapse to a single       *)
(*  point, all differences would vanish, and by      *)
(*  existence_is_difference, existence itself         *)
(*  would be annihilated.                            *)
(*                                                   *)
(*  Top = 0-dimensional point = no distinction       *)
(*      = no difference = no existence.              *)
(*                                                   *)
(*  In type theory terms, Top is Never/Empty,        *)
(*  NOT Unit. Reaching Top annihilates all           *)
(*  inhabitants: no entity survives projection       *)
(*  to a dimension with zero distinguishing power.   *)
(*  Just as Never has no inhabitants, Top has no      *)
(*  surviving entities. It is unreachable by          *)
(*  construction — not forbidden, but impossible.    *)
(*                                                   *)
(*  This is why dim_le is a preorder, not a          *)
(*  lattice: the framework does not require Top.     *)
(*                                                   *)
(*  The definition below is kept to show that        *)
(*  IF such a dimension existed, everything          *)
(*  would be comparable — but this is precisely      *)
(*  the condition under which all identity is lost.  *)
(* ================================================ *)
